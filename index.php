...
<body class="bg-white min-h-screen flex flex-col font-['Outfit'] relative overflow-x-hidden">
    ...
    <nav class="flex justify-between items-center p-6 bg-white/95 backdrop-blur-sm shadow-sm z-30 sticky top-0">
        ...
        <div class="flex gap-10 text-gray-500 font-semibold items-center text-lg hidden md:flex">
            ...
            <a href="app/views/class.php" class="relative group <?= $current_page == 'class.php' ? 'text-[#b829e3]' : 'hover:text-[#b829e3]' ?> transition-colors duration-300">
                Class
            ...
            <a href="app/views/streak.php" class="relative group <?= $current_page == 'streak.php' ? 'text-[#b829e3]' : 'hover:text-[#b829e3]' ?> transition-colors duration-300">
                Streak
        ...
        <div class="flex gap-4 items-center">
            <?php if (isset($_SESSION['username'])): ?>
                ...
                <a href="app/controllers/logout.php" class="border-2 border-red-400 text-red-500 px-6 py-2 rounded-full font-bold shadow-sm hover:bg-red-50 hover:-translate-y-0.5 transition-all duration-300">Log Out</a>
            <?php else: ?>
                <a href="app/views/login.php" class="text-[#b829e3] font-bold hover:text-[#9b1ebf] px-4 py-2 transition-colors duration-300">Log In</a>
                <a href="app/views/register.php" class="bg-[#b829e3] hover:bg-[#9b1ebf] text-white px-8 py-2.5 rounded-full font-bold shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300">Sign Up</a>
            <?php endif; ?>
        </div>
    </nav>
